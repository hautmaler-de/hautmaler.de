...
- [ ] Add a minimal Node-based development and CI toolchain without converting the
...
- [ ] Add Playwright browser tests and axe accessibility checks for the preview gate,
...
- [ ] Implement one reproducible release-readiness command that reports technical
  checks separately from external approvals and never marks an external approval as
  completed automatically.
- [ ] Create a versioned machine-readable media manifest plus `docs/MEDIA_MANIFEST.md`.
...
- [ ] Add a reproducible responsive-image derivative script for suitable existing
...
- [ ] Improve portfolio presentation accessibility: semantic grouping, persistent or
  keyboard-reachable captions and focus styling; add a lightweight accessible detail
  dialog only if Escape, focus return, and reduced motion remain reliable.
- [ ] Add or correct technical SEO and static security controls: canonical and
...
- [ ] Create `docs/VERIFICATION_MATRIX.md`, `docs/RELEASE_CHECKLIST.md`, and
  ...
  dependencies.
- [ ] Run the complete static, external-link, E2E, axe, media, responsive, visual,
